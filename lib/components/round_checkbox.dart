...
class _CheckboxState extends State<RoundCheckbox> with TickerProviderStateMixin {
  @override
...
const double _kEdgeSize = RoundCheckbox.width;
const Radius _kEdgeRadius = Radius.circular(100);
